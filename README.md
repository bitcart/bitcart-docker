...
| BITCART_FRONTEND_HOST         | Host where to run BitcartCC Ready Store. Is used when store component is enabled.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | :x:         | App       |
| BITCART_ADMIN_HOST            | Host where to run BitcartCC Admin Panel. Is used when admin component is enabled.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | :x:         | App       |
| BITCART_FRONTEND_URL          | URL of BitcartCC Merchants API instance. It can be your instance hosted together with store or a completely separate instance. In case of default setup (store+admin+API at once), you need to set it to https://$BITCART_HOST or (http if nginx-https component is not enabled).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | :x:         | App       |
| BITCART_ADMIN_URL             | Same as BITCART_FRONTEND_URL, but for configuring your admin panel.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | :x:         | App       |
