...
export BITCART_CRYPTO1=${BITCART_CRYPTO1:-btc}
export BITCART_CRYPTO2=$BITCART_CRYPTO2
export BITCART_CRYPTO3=$BITCART_CRYPTO3
export BITCART_CRYPTO4=$BITCART_CRYPTO4
export BITCART_CRYPTO5=$BITCART_CRYPTO5
export BITCART_CRYPTO6=$BITCART_CRYPTO6
export BITCART_CRYPTO7=$BITCART_CRYPTO7
export BITCART_CRYPTO8=$BITCART_CRYPTO8
export BITCART_CRYPTO9=$BITCART_CRYPTO9
